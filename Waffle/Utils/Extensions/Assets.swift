...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let card0 = ImageAsset(name: "card-0")
    internal static let card1 = ImageAsset(name: "card-1")
    internal static let card2 = ImageAsset(name: "card-2")
    internal static let card3 = ImageAsset(name: "card-3")
    internal static let card4 = ImageAsset(name: "card-4")
    ...
    internal static let alarmDayDot = ImageAsset(name: "alarmDayDot")
    internal static let link = ImageAsset(name: "link")
    internal static let text = ImageAsset(name: "text")
    internal static let detailWapple0 = ImageAsset(name: "detailWapple-0")
    ...
    internal static let memoWapple0 = ImageAsset(name: "memoWapple-0")
    ...
    internal static let mapComingSoon = ImageAsset(name: "mapComingSoon")
    ...
    internal static let wapple0 = ImageAsset(name: "wapple-0")
