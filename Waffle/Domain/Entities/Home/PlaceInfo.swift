...
struct PlaceInfo: Codable {
    ...
    static let dummyPlace = PlaceInfo(placeId: 0, title: "이성당", place: "대구 수성구", isConfirm: false, category: Category(name: "카페", index: 1), likeCount: 4, likeSelected: false, memo: "이성당 빵집 가서 꼭 야채빵 사기")
}
